  ...
  reducers: {
    setCredentials(
      ...
      if (accessToken !== undefined) {
        ...
        if (accessToken) {
          void AsyncStorage.setItem("erp_access_token", accessToken);
        } else {
          void AsyncStorage.removeItem("erp_access_token");
        }
      }
      ...
      if (refreshToken !== undefined) {
        ...
        if (refreshToken) {
          void AsyncStorage.setItem("erp_refresh_token", refreshToken);
        } else {
          void AsyncStorage.removeItem("erp_refresh_token");
        }
      }
      ...
      if (user !== undefined) {
        state.user = user;
        if (user) {
          void AsyncStorage.setItem("erp_user", JSON.stringify(user));
        } else {
          void AsyncStorage.removeItem("erp_user");
        }
      }
      ...
      if (school !== undefined) {
        state.school = school;
        if (school) {
          void AsyncStorage.setItem("erp_school", JSON.stringify(school));
        } else {
          void AsyncStorage.removeItem("erp_school");
        }
      }
    ...
    setUser(state, action: PayloadAction<User | null>) {
      state.user = action.payload;
      if (action.payload) {
        void AsyncStorage.setItem("erp_user", JSON.stringify(action.payload));
      } else {
        void AsyncStorage.removeItem("erp_user");
      }
    },
    ...
    setSchool(state, action: PayloadAction<School | null>) {
      state.school = action.payload;
      if (action.payload) {
        void AsyncStorage.setItem("erp_school", JSON.stringify(action.payload));
      } else {
        void AsyncStorage.removeItem("erp_school");
      }
    },
    ...
    setActiveSchoolId(state, action: PayloadAction<string | null>) {
      state.activeSchoolId = action.payload || null;
      if (action.payload) {
        void AsyncStorage.setItem("erp_active_school", action.payload);
      } else {
        void AsyncStorage.removeItem("erp_active_school");
      }
    },
